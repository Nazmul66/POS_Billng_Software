...
@section('body-content')
    ...
    <!--breadcrumb-->
        @include('admin.include.breadcrumb', ['breadcrumb_name' => 'Update Products'])
    <!--end breadcrumb-->
            ...
            <form action="{{ route('admin.product.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input class="form-control" id="purchase_price" type="number" name="purchase_price" min="0" value="{{ old('purchase_price', $product->price) }}" placeholder="Purchase Price....">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input class="form-control" id="selling_price" type="number" name="selling_price" min="0" value="{{ old('selling_price', $product->offer_price) }}" placeholder="Selling Price....">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select" id="units" name="units">
                            @foreach ($units as $row)
                                <option value="{{ $row->short_name }}"  {{ (old('units', $product->units ?? '') == $row->short_name) ? 'selected' : '' }}>{{ $row->short_name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
