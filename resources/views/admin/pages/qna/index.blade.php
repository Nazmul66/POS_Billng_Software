...
{{-- Active Menu Sidebar --}}
@section("qna", 'mm-active')


@section('body-content')

<!--breadcrumb-->
   @include('admin.include.breadcrumb', ['breadcrumb_name' => 'Manage QNA'])
<!--end breadcrumb-->
    ...
    <div class="card">
        <div class="card-header p-3">
            <div class="d-flex justify-content-between align-items-center">
                <h4 class="card-title m-0">QNA List</h4>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="myModalLabel">Create QNA</h5>
                    ...
                    <div class="modal-body">
                        <form id="createForm" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="question" id="question" cols="30" rows="10" placeholder="Write here...."></textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control"  name="answer" id="answer" cols="30" rows="10" placeholder="Write here...."></textarea>
        ...
        <div id="editModal" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" data-bs-scroll="true"
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="myModalLabel">Update QNA</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    ...
                    <div class="modal-body">
                        <form id="EditForm" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="question" id="up_question" cols="30" rows="10" placeholder="Write here...."></textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="answer" id="up_answer" cols="30" rows="10" placeholder="Write here...."></textarea>
        ...
        style="display: none;" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="myModalLabel">View QNA List</h5>
            ...
            $('#createForm').submit(function (e) {
                ...
                $.ajax({
                    ...
                    error: function (err) {
                        ...
                        $('#question_validate').empty().html(error.name);
                        $('#answer_validate').empty().html(error.name);
