            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-5">
                    ...
                    <div class="row align-items-center mb-2">
                        ...
                        <div class="col-lg-8">
                            <div class="form__input">
                                <input class="form-control" id="basicInput" name="time_in" type="date" placeholder="Select Date" value="{{ $vehicles_report->time_in }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center mb-2">
                        ...
                        <div class="col-lg-8">
                            <div class="form__input">
                                <input class="form-control" type="date" name="time_out" id="basicInput2" placeholder="Select Date" value="{{ $vehicles_report->time_out }}">
                            </div>
                        </div>
                    </div>
                </div>
