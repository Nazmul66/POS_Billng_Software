...
<!--breadcrumb-->
   @include('admin.include.breadcrumb', ['breadcrumb_name' => 'Manage Categories'])
<!--end breadcrumb-->
    ...
    <div class="card">
        <div class="card-header p-3">
            <div class="d-flex justify-content-between align-items-center">
                <h4 class="card-title m-0">Categories List</h4>
                    ...
                    <div class="modal-body">
                        <form id="createForm" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" id="category_name" type="text" name="name" placeholder="Category Name">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" class="form-control" name="img" id="category_img" accept=".png, .jpeg, .jpg, .webp" onchange="previewImage(event)">
                    ...
                    <div class="modal-body">
                        <form id="EditForm" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" id="up_category_name" type="text" name="name" placeholder="Category Name">

                                <span id="up_name_validate" class="text-danger validation-error mt-1"></span>
                            </div>

                            <div class="mb-3">
                                <label for="up_cat_img" class="form-label">Image <sup class="text-danger" style="font-size: 12px;">* resolution(160px x 160px)</sup></label>
                                <input type="file" class="form-control" name="img" id="up_cat_img" accept=".png, .jpeg, .jpg, .webp" onchange="imageShow(event)">
            ...
            $(document).on("click", '#editButton', function (e) {
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        ...
                        $('#id').val(data.id);
                        $('#up_category_name').val(data.name);
                        $('#imageShow').html('');
                        $('#imageShow').append(`
                          <a href="{{ asset("`+ data.img +`") }}" target="__blank">
                            <img src='{{ asset("`+ data.img +`") }}' alt="" style="width: 100px; height: 100px;">    
                          </a>
                        `);
            ...
            $(document).on("click", '#viewButton', function (e) {
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        ...
                        $('#view_category_name').html(data.name);
                        $('#viewImageShow').html('');
